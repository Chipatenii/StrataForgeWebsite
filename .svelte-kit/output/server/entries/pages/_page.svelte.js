...
function _page($$renderer) {
  $$renderer.push(`<div class="home-page"><section id="hero" class="hero svelte-1uha8ag"><div class="container hero-content svelte-1uha8ag"><div class="hero-text svelte-1uha8ag"><h1 class="svelte-1uha8ag">We build your systems and brand, then help them grow.</h1> <p class="subtext svelte-1uha8ag">Scalable websites, custom apps, and premium brand identities
                    forged for Zambian SMEs and growing regional brands—then
                    amplified with data-driven marketing.</p> <div class="hero-ctas svelte-1uha8ag"><a href="/contact" class="btn btn-primary">Book a Discovery Call</a> <a href="/services" class="btn btn-outline">View Services</a></div></div> <div class="hero-visual svelte-1uha8ag"><div class="visual-mockup svelte-1uha8ag"><img src="/images/hero_visual.png" alt="Modern Dashboard" class="hero-image svelte-1uha8ag"/></div></div></div></section> <section class="who-we-help bg-neutral"><div class="container"><h2 class="section-title text-center mb-4">Empowering the engines of Zambia's economy.</h2> <div class="help-grid svelte-1uha8ag"><div class="help-item svelte-1uha8ag"><span>SMEs &amp; Growing Businesses</span></div> <div class="help-item svelte-1uha8ag"><span>Colleges &amp; Institutions</span></div> <div class="help-item svelte-1uha8ag"><span>Finance &amp; Fintech</span></div> <div class="help-item svelte-1uha8ag"><span>Service Brands</span></div></div></div></section> <section id="pillars" class="pillars"><div class="container"><div class="text-center mb-6"><h2 class="section-title">Built in layers. Forged for growth.</h2> <p class="section-subtitle">A holistic approach to digital excellence.</p></div> <div class="pillars-grid svelte-1uha8ag"><div class="pillar-card svelte-1uha8ag"><div class="icon-wrapper svelte-1uha8ag">`);
  ...
  $$renderer.push(`<!----></div> <h3 class="svelte-1uha8ag">Digital Growth</h3> <p class="svelte-1uha8ag">Targeted campaigns designed to turn traffic into
                        measurable leads and sales.</p> <a href="/services#marketing-growth" class="svelte-1uha8ag">Learn more →</a></div></div></div></section> <section id="featured-services" class="featured-services bg-neutral"><div class="container"><div class="grid-2 svelte-1uha8ag"><div class="service-card svelte-1uha8ag"><div class="icon-wrapper mb-3 svelte-1uha8ag">`);
