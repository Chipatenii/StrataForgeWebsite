...
function _page($$renderer) {
  ...
  $$renderer.push(`<!----></div> <h3 class="svelte-1uha8ag">Systems &amp; Development</h3> <p class="svelte-1uha8ag">Custom-coded tools and websites built on secure,
                        scalable architecture.</p> <a href="/services#systems-dev" class="svelte-1uha8ag">Learn more →</a></div> <div class="pillar-card glass-panel svelte-1uha8ag"><div class="icon-wrapper svelte-1uha8ag">`);
  ...
  $$renderer.push(`<!----></div> <h4 class="svelte-1uha8ag">Business Websites</h4> <p class="svelte-1uha8ag">High-performance, mobile-first windows to your business.</p></div> <div class="service-card glass-panel svelte-1uha8ag"><div class="icon-wrapper mb-3 svelte-1uha8ag">`);
  ...
  $$renderer.push(`<!----></div> <h4 class="svelte-1uha8ag">Web Apps &amp; Tools</h4> <p class="svelte-1uha8ag">Custom software built to solve unique operational
                        bottlenecks.</p></div> <div class="service-card glass-panel svelte-1uha8ag"><div class="icon-wrapper mb-3 svelte-1uha8ag">`);
  Pencil_ruler($$renderer, { size: 24 });
  $$renderer.push(`<!----></div> <h4 class="svelte-1uha8ag">UI/UX Design</h4> <p class="svelte-1uha8ag">Human-centered design that prioritizes your users.</p></div> <div class="service-card glass-panel svelte-1uha8ag"><div class="icon-wrapper mb-3 svelte-1uha8ag">`);
