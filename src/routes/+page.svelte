	...
	<section id="hero" class="hero">
		<div class="container hero-content fade-up-element" use:inView>
			<div class="hero-text">
				...
				<p class="subtext">
					Scalable websites, custom apps, and premium brand identities forged for Zambian SMEs and
			...
			<div class="hero-visual">
				<div class="visual-mockup">
					<img src="/images/hero_visual.png" alt="Modern Dashboard" class="hero-image" />
				</div>
			</div>
		</div>
	</section>
